...
if(!isset($_SESSION['user_email'])){
	...
	{
	$dob[]= array();
	 $dob=explode("-", $user_birthday);
	 $day=$dob[2];
	 $month=$dob[1];
	 $year=$dob[0];
	// echo"<script>alert($day+'/'+$month+'/'+$year)</script>";
}
?>
<html>
<head>
		...
		<form action="" method="post" enctype="multipart/form-data">
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td>
						<input class="form-control input-md" type="date" name="u_birthday"  value="<?php echo' $month."/".$day."/".$year;'?>">
					</td>
				</tr>
...
<?php
	...
	if (isset($_POST['update']))
	{
		...
		$update = "update users set f_name='$f_name', l_name='$l_name', describe_user='$describe_user', Relationship='$Relationship_status', user_pass='$u_pass', user_email='$u_email', user_country='$u_country', user_gender='$u_gender', user_birthday='$user_birthday' where user_id='$user_id'" ;
